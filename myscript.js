...
theTime.add({
	...
	update: function(percent) {
		...
		document.querySelector('.container .sup').innerHTML= "Tại hạ tim đập chân runn " + (thePercent+899);
	}
});
theTime.add({
	targets: getHeart,
...
document.querySelector('.Description .modal-title').innerHTML = '<i class="far fa-comment-alt"></i>&nbsp;Tim đập chân run vì:';
document.querySelector('.Description .modal-body').innerHTML = 'Lần đầu chúc mừng sinh nhật công túaa có gì sai sót mong công túa thứ tộiii <i class="fas fa-heart"></i> ';
